...
C -> 여러분영어이름 -> HTML_CSS -> 우클릭 새폴더
-> 10000hoursrule -> 우클릭 open git bash -> code . 엔터

최소 HTML을 완성하고, 다 되신 분들은 예습한다 생각하시면서 CSS를 작성해보시기 바랍니다.

그리고 CSS까지 끝내신 분들은 JS로 가셔도 좋지만,
금일 안내드렸던 HTML 태그 관련 정리 문서를 작성해보시기 바랍니다.
이번 영상에 있었던 태그들도 포함해야합니다.

안내는 영상에서 충분히 잘해주지만 질문 해주시면 됩니다!!!(●'◡'●)